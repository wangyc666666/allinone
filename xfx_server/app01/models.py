...
class DocumentData(models.Model):
    ...
    summary = models.CharField('备注', max_length=256, blank=True, null=True)
    sale_content = models.CharField('月售', max_length=256, blank=True, null=True)
    #content = RichTextField('内容', blank=True, null=True)
    content = MDTextField(verbose_name='内容')
    course_price = models.IntegerField('价格(默认免费)', blank=True, default=0)
    num = models.IntegerField('数量', blank=True, default=0)
