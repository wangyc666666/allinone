...
$(function(){
  ...
  new AutoAD({
      ADD:$('<a href="http://edu.51cto.com/activity/3.html" class="closeMB" target="_blank" styel="display:block;"><img src="https://s1.51cto.com/images/201708/31/2e81165bd222bbfb57292140c27bf147.png"></a><a class="closeMB" style="position: absolute;right: 92px;top: 69px;width: 50px;height: 50px;cursor: pointer;" href="javascript:;"></a>'),
      W:600,
      H:500,
      cookie:'sBox',
      mask:"#000",
